                            ...
                            <div class="widget-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input value="{{$cateInfo->cate_name}}" type="text" class="form-control" id="catename" name="cate_name" placeholder="栏目名称" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sort" class="col-sm-2 control-label no-padding-right">栏目排序</label>
                                        <div class="col-sm-6">
                                            <input value="{{$cateInfo->sort}}" type="text" class="form-control" id="sort" name="sort" placeholder="栏目排序" />
